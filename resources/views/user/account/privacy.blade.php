...
<body>
    <main>
            ...
            <div class="d-flex justfy-content-between flex-wrap">
                                    <div class="nav1 m-3   ">
                                        <p class="dropdown-header">Course Creation 1</p>
                                    <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                    <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                    ...
                                    <div class="nav2 m-3  ">
                                        <p class="dropdown-header">Course Creation2</p>
                                    ...
                                    <div class="nav3 m-3  ">
                                        <p class="dropdown-header">Course Creation3</p>
                                        <a class="dropdown-item" href="{{url('addcourse')}}">Add Course</a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
                                     <a class="dropdown-item d-flex justify-content-between" href="#">Course Name  <i class="fas fa-chevron-right lfa"></i></a>
    ...
    <ul class="custom-scrollbar">
        ...
        <li>
            <ul class="collapsible collapsible-accordion">
                ...
                <li><a class="collapsible-header waves-effect arrow-r"><i class="far fa-envelope"></i>
...
<!--/. Sidebar navigation -->
                ...
                <nav class="navbar navbar-expand-lg  bg-dark navbar-dark">
                    <h2><a class="navbar-brand  font-weight-bolder" href="#" style="  font-size:50px">Nakwalify
                        </a></h2>

                    <div class="collapse navbar-collapse" id="navbarSupportedContent1">

                        <div class="dropdown show w-100"> <a
                                class="btn btn-dark home-dark dropdown-toggle font-weight-bolder" href="#" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Courses </a>
                            <div class="dropdown-menu ">
                                <div class="d-flex  flex-wrap">
                                    <div>
                                        <p class="dropdown-header">Course Creation</p>
                                        <a class="dropdown-item" href="{{url('addcourse')}}">Add Course</a>
                                    ...
                                    <div>
                                        <p class="dropdown-header">Course Category 1</p>
                                        <a class="dropdown-item" href="#">Course Name</a>
                                        <a class="dropdown-item" href="#">Course Name</a>
                                        <a class="dropdown-item" href="#">Course Name</a>
                                        <a class="dropdown-item" href="#">Course Name</a>
                    ...
                    <button type="button" class="btn btn-dark signin" data-toggle="modal" data-target="#signin">Sign
                        In</button>
                    ...
                    <div class="container">
                        <div class="d-flex justify-content-lg-between flex-wrap mt-5">
                            <h3 class="bolder">Welcome back <span class="bg-success">Kelvin</span>, ready for your next
                                lesson?</h3>
                            <a class="btn btn-default border border-dark  hist">View Watch History</a>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="container-fluid mb-5">
                        <div class="d-flex justify-content-between flex-wrap ">
                            ...
                            <a class="btn btn-default border border-dark m-2">View List</a>
                        </div>
                    ...
                    <div class="container-fluid mb-5 mt-5">
                        <div class="d-flex justify-content-between flex-wrap">
                            ...
                            <a class="btn btn-default border border-dark m-2 font-weight-bold">View All WarkShops</a>
                        </div>
                    ...
                    <div class="container-fluid mb-5">
                        <div class="d-flex justify-content-between flex-wrap ">
                            ...
                            <a class="btn btn-default border border-dark font-weight-bold m-2">View All</a>
                        </div>
