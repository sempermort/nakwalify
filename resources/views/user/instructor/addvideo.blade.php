                        ...
                        <div class="card col-8 border-radius-0 m-2 p-0  border-left-0 border-right-0">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active h-350" id="videos" role="tabpanel"
                                    ...
                                    <iframe width="560" height="340" class="object-cover h-100 w-100" id="vidcanva"
                                        allow="autoplay; encrypted-media" src="" frameborder="0" allowfullscreen>
                                ...
                                <div class=" bg-darknavy p-5">
                                    <div class="">
                                        ...
                                        <div class=" row  mt-2">
                                            ...
                                            <div class=" col-md-8 border-radius-0  p-0  border-left-0 border-right-0"
                                                id="mediav">

                                                <video width="400" id="mainvid" height="240"
                                                    poster="{{asset('assets/images/course_4.jpg')}}"
