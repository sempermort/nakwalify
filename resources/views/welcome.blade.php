...
@section('content')
    ...
    <Main>
                                        ...
                                        <div class="w-100">
                                            <div class="col-10  m-auto tabs-container">
                                                <div class=" d-flex mb-3">
                                                    ...
                                                    <button class="col-6 btn btn-primary active" id="tab1"
                                                        data-toggle="tab" href="#tab-1"> Student Account</button>
                                                ...
                                                <div id="tab-1" class="@tabpane2">
                                                    <div class="panel-body">
                                                        <div class="form-horizontal col-10  m-auto">
                                                            <button class="col-12 btn btn-outline-dark">Continue With
                                                                Google</button>
                                                            <button class="col-12 btn btn-outline-dark">Continue With
                                                                Facebook</button>
                                                            <button class="col-12 btn btn-outline-dark">Continue With
                                                            ...
                                                            <form action="">
                                                                <div class=" form-group mb-1">
                                                                    <div class="d-flex  justify-content-between">
                                                                        ...
                                                                        <input type="text" name="LastName" id="LastName"
                                                                            ...
                                                                            style="width: 48%;" placeholder="Last Name">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class=" form-group m-2">
                                                                    <div class="text-center m-auto ">
                                                                        <button
                                                                            class="form-control m-auto w-80 btn-primary">Sign
                                                                            Up</button>

                                                                        <p>Already a Member <button
        ...
        <section>
            <div class="contan" style="margin-top: -19px;">
                                ...
                                <div class="col-10  m-auto tabs-container">
                                    <div class=" d-flex mb-3">
                                        ...
                                        <button class="col-6 btn btn-primary active" id="tab1" data-toggle="tab"
                                            href="#tab-1"> Student Account</button>
                                        <button class="col-6 btn-outline-dark " id="tab2" data-toggle="tab"
                                            href="#tab-2">
                                                ...
                                                <form action="">
                                                    <div class=" form-group mb-1">
                                                        <div class="d-flex  justify-content-between">
                                                            ...
                                                            <input type="text" name="LastName" id="LastName"
                                                                class="form-control w-40" style="width: 48%;"
                                                    ...
                                                    <div class=" form-group mb-1">
                                                        <div class="d-flex justify-content-between">
                                                            <input type="text" name="Ccode" id="Ccode"
                                                                class="form-control " style="width: 28%;" value="+255">

                                                            <input type="text" name="phonenumber" id="phonenumber"
                                                                class="form-control" style="width: 68%;">
                                                    ...
                                                    <div class=" form-group m-2">
                                                        <div class="text-center m-auto ">
                                                            <button class="form-control m-auto w-80 btn-primary">Sign
                                                                Up</button>
            ...
            <div class="mt-5">
                ...
                <div class="m-150-20">
                    <div class="row mt-5">
                        ...
                        <div class="col-md-8">
                            <img src="{{asset('assets/images/ezgif.com-gif-maker.jpg')}}" class="rounded  img-fluid" width="1048"
                                height="576" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-150-20">
                    <div class="row mt-5">
                        ...
                        <div class="col-md-8">
                            <img src="{{asset('assets/images/ezgif.com-gif-maker3.jpg')}}" class="rounded img-fluid" width="1048"
                                height="576" alt="">
                        </div>
                    </div>
                </div>
